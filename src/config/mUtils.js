...
export const loadMore = (element, callback) => {
    ...
    let requestFram;
    let oldScrollTop;
    // let docBody = document.documentElement;//本地
    let docBody = document.body;//测试
    
    // let docBody = document.body||document.documentElement;//测试
    ...
    element.addEventListener('touchend',() => {
       	oldScrollTop = docBody.scrollTop;
        moveEnd();
        // alert(docBody.scrollTop+"----"+windowHeight+"-----"+height+"----"+setTop+"----"+paddingBottom+"-----"+marginBottom)
           
    },{passive: true})
    
    const moveEnd = () => {
        requestFram = requestAnimationFrame(() => {
            if (docBody.scrollTop != oldScrollTop) {
                oldScrollTop = docBody.scrollTop;
                loadMore();
                moveEnd();
            }else{
        ...
        if (docBody.scrollTop + windowHeight >= height + setTop + paddingBottom + marginBottom) {
            callback();
        }
    }
}
